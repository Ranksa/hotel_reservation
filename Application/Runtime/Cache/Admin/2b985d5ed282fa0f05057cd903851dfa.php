  ...
  <div class="sidebar-content">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            ...
            <form id="myform" name="myform" method="post" action="/thinkphp_hotel/index.php/Admin/Rmanage/rt_update?mtid=<?php echo ($list["typeid"]); ?>">
                <table width="100%" height="173" border="0" align="center" cellpadding="2" cellspacing="1" class="result-tab">
                    <tr>
                        ...
                        <td width="%85" class="td_bg"> <input name="typename" type="text" id="typename" value="<?php echo ($list["typename"]); ?>" size="30" maxlength="50" /></td>
                    </tr>
                    <tr>
                        <td align="right" class="td_bg">房间面积：</td>
                        <td class="td_bg"> <input name="area" type="text" id="area" value="<?php echo ($list["area"]); ?>" size="30" maxlength="50" /></td>
                    </tr>
                    <tr>
                        <td align="right" class="td_bg">床位数量：</td>
                        <td class="td_bg"> <input name="bednum" type="text" id="bednum" value="<?php echo ($list["hasfood"]); ?>" size="30" maxlength="50" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td_bg"><input name="price" type="text" id="price" value="<?php echo ($list["price"]); ?>" size="10" maxlength="15" />元</td>
                    </tr>
                    <tr>
                        <td align="right" class="td_bg">房间数量：</td>
                        <td class="td_bg"><input name="totalnum" type="text" id="totalnum" value="<?php echo ($list["totalnum"]); ?>" size="10" maxlength="15" />间</td>
                    </tr>
                    <tr>
                        <td align="right" class="td_bg">剩余数量：</td>
                        <td class="td_bg"><input name="leftnum" type="text" id="leftnum" value="<?php echo ($list["leftnum"]); ?>" size="10" maxlength="15" />间</td>
                    </tr>
                    <tr>
                        <td align="right" class="td_bg"><input type="reset" class="btn btn-warning" name="submit2" id="button2" value="重置" /></td>
                        <td class="td_bg">
                            <input type="hidden" name="action" value="modify">
                            <input type="submit" name="submit" class="btn btn-info" id="button" value="提交" />
                        </td>
                    </tr>
                </table>
