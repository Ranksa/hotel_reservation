  ...
  <div class="sidebar-content">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/thinkphp_hotel/index.php/Admin/index">后台管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">退房清算</span></div>
        </div>
        <center>
            <div class="search-wrap">
                <div class="search-content">
                    <form action="/thinkphp_hotel/index.php/Admin/Checkout/checkout" method="post">
            ...
            <div class="result-content">
                ...
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <th class='tc'><?php echo ($vo["cardtype"]); ?></th>
                        <th class='tc'><?php echo ($vo["cardid"]); ?></th>
                        <th class='tc'><?php echo ($vo["cname"]); ?></th>
                        <th class='tc'><?php echo ($vo["csex"]); ?></th>
                ...
                <table class="result-tab" width="100%">
                    ...
                    <br/>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                              ...
                              <th class='tc'><?php echo ($vo["datenum"]); ?></th>
                              <th class='tc'><?php echo ($list2[0]['typename']); ?></th>
                              <th class='tc'><?php echo ($list2[0]['price']); ?></th>
                              <th class='tc'> <?php echo ($monetary); ?></th>
                          ...
                          <tr>
                              ...
                              <th class='tc'></th>
                              <th class='tc'>
                                  <a href='/thinkphp_hotel/index.php/Admin/Checkout/out_update?crid=<?php echo ($vo["roomid"]); ?>&money=<?php echo ($monetary); ?>&typeid=<?php echo ($vo["typeid"]); ?>&orderid=<?php echo ($vo["orderid"]); ?>'
                                 class='link-update'>确认退房</a></th>
                              <th class='tc'></th>
                              <th class='tc'></th>
                              <th class='tc'></th>
                              <th class='tc'></th>
